...
void MX_ADC1_Init(void)
{
  ...
  PC3   ------> ADC1_IN13
  */
  GPIO_InitStruct.Pin = Y_VAL_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(Y_VAL_GPIO_Port, &GPIO_InitStruct);
...
void MX_ADC2_Init(void)
{
  ...
  PA3   ------> ADC2_IN3
  */
  GPIO_InitStruct.Pin = X_VAL_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(X_VAL_GPIO_Port, &GPIO_InitStruct);
...
void MX_ADC3_Init(void)
{
  ...
  PC0   ------> ADC3_IN10
  */
  GPIO_InitStruct.Pin = POT_A_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(POT_A_GPIO_Port, &GPIO_InitStruct);

  GPIO_InitStruct.Pin = POT_B_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_ANALOG;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(POT_B_GPIO_Port, &GPIO_InitStruct);
...
/* Sensor láser X: PA3 / ADC2 IN3 (antes PA7/IN7 — ver Docs y app_rt.c).
 * Sensores Y: PC3 / ADC1 IN13. El muestreo a 1 MHz lo gestiona app_rt.c. */
